    ...
    <section className="section">
      <div className="container mx-auto relative">
        ...
        <div className="flex gap-5 py-12 lg:flex-col">
          <h3 className="title lg:max-w-[245px] lg:mt-[30px] lg:mb-[90px] text-primary">
            {title}
          </h3>
          <p className="subtitle lg:max-w-[245px] font-light text-xl text-secondary">
            {subtitle}
          </p>
          <div className="hidden lg:flex items-center">
            <a
              className="font-medium transition-all lg:text-lg 
						hover:border-b hover:border-primary lg:items-center text-primary "
              href={<Hero />}
            >
              <span>{link}</span>
            </a>
