  ...
  return (
    <section className="w-full h-[850px] bg-hero bg-right bg-cover bg-no-repeat text-white pt-[225px] pb-[254px]  relative mb-12 lg:bg-cover lg:mb-28">
      <div className="container mx-auto text-center">
        ...
        {/* button */}
        <button className="bg-[var(--btn-light)] hover:bg-accent backdrop-blur-md p-2 px-9 mb-[159px] rounded-md transition lg:px-[80px] lg:py-[16px] lg:mb-[194px] lg:text-xl">
          {buttonText}
        </button>
        {/* Stats */}
        <div>
